...
module.exports = {
  ...
  attributes: {
          ...
          EtapasInscriId: { type:'number', allowNull:true },
          ...
          InscriTurno: { type:'string', allowNull:true },
          ...
          AdultoIdInscri1: { type:'number', allowNull:true },
          AdultoIdInscri2: { type:'number', allowNull:true },
